...
<div style={{ fontSize: 28, fontFamily: “‘Cormorant Garamond’,serif”, fontWeight: 500, color: “#fff”, lineHeight: 1 }}>
{String(value).padStart(2, “0”)}
</div>
<div style={{ fontSize: 9, letterSpacing: “0.12em”, textTransform: “uppercase”, color: GOLD + “bb”, marginTop: 4 }}>{label}</div>
</div>
);
